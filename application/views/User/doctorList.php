...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 well">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 ">
        <p>No Of New <?php
            ...
            ?> Targeted For <?php echo $this->User_model->getMonthName($this->nextMonth); ?> <?php echo date('Y', strtotime($this->nextYear)); ?> : <b ><input type="text" class="form-control ck" style="width:40%" readonly="readonly" value="<?php echo isset($show4['target']) ? $show4['target'] : 0; ?>"></b></p>
        <p>Balanced <?php
            if ($this->Product_Id == '1') {
                echo "Vials";
            } else {
            ...
            ?> To Plan For <?php echo $this->User_model->getMonthName($this->nextMonth); ?> <?php echo date('Y', strtotime($this->nextYear)); ?>: <span class="ckk"></span></p>
    </div>
    <style>
        ul {
